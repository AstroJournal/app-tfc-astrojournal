package com.app.astrojournal.test.ui.fakes
...
class FakeCollectibleStore : CollectibleStore {
    ...
    override fun getByEventId(eventId: Long): Collectible? = rows.lastOrNull { it.eventId == eventId }
    ...
    private fun updateById(id: Long, block: (Collectible) -> Collectible) {
